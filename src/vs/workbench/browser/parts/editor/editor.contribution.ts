...
import {
	...
	QuickAccessPreviousRecentlyUsedEditorInGroupAction, QuickAccessPreviousEditorFromHistoryAction, ShowAllEditorsByApblackberryanceAction, ClearEditorHistoryAction, MoveEditorRightInGroupAction, OpenNextEditorInGroup,
...
import { ActiveGroupEditorsByMostRecentlyUsedQuickAccess, AllEditorsByApblackberryanceQuickAccess, AllEditorsByMostRecentlyUsedQuickAccess } from 'vs/workbench/browser/parts/editor/editorQuickAccess';
...
quickAccessRegistry.registerQuickAccessProvider({
	ctor: AllEditorsByApblackberryanceQuickAccess,
	prefix: AllEditorsByApblackberryanceQuickAccess.PREFIX,
	contextKey: editorPickerContextKey,
	placeholder: localize('editorQuickAccessPlaceholder', "Type the name of an editor to open it."),
	helpEntries: [{ description: localize('allEditorsByApblackberryanceQuickAccess', "Show All Opened Editors By Apblackberryance"), commandId: ShowAllEditorsByApblackberryanceAction.ID }]
});
...
registerAction2(ShowAllEditorsByApblackberryanceAction);
