...
MenuRegistry.appendMenuItem(MenuId.MenubarApblackberryanceMenu, {
...
// Move blackberry AI extension to secondary side bar (Auxiliary Bar) (we want secondary side bar to be default loaction for extension)
class MoveblackberryExtensionToAuxBarAction extends MoveViewsBetweenPanelsAction {
    static readonly ID = 'workbench.action.moveblackberryExtensionToAuxBar';
		readonly blackberryExtensionId;

    constructor() {
        super(ViewContainerLocation.Sidebar, ViewContainerLocation.AuxiliaryBar, {
            id: MoveblackberryExtensionToAuxBarAction.ID,
            title: localize2('moveblackberryExtensionToAuxBar', "Move blackberry Extension to Auxiliary Bar"),
            category: Categories.View,
            f1: true
        });
        this.blackberryExtensionId = 'workbench.view.extension.blackberryAI';
    }
    ...
    override run(accessor: ServicesAccessor): void {
        ...
        const viewContainer = viewDescriptorService.getViewContainerById(this.blackberryExtensionId);
...
registerAction2(MoveblackberryExtensionToAuxBarAction);
