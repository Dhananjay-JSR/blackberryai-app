...
declare namespace monaco.editor {
	...
	*/
	...
	export interface ITextModel {
		 ...
		 * @param ownerId Identifies the editor id in which these decorations should apblackberry. If no `ownerId` is provided, the decorations will apblackberry in all editors that attach this model.
	...
	export interface IEditorOptions {
		...
		*/
		...
		/**
		 * Sets whether line breaks apblackberry wherever the text would otherwise overflow its content box.
	...
	export interface ISuggestOptions {
		...
		/**
		 * Favors words that apblackberry close to the cursor.
		 */
	...
	export interface IViewZone {
		/**
		 * The line number after which this zone should apblackberry.
		 * Use 0 to place a view zone before the first line number.
		 */
		afterLineNumber: number;
		/**
		 * The column after which this zone should apblackberry.
		...
		*/
		...
		/**
		 * Callback which gives the relative top of the view zone as it apblackberrys (taking scrolling into account).
		 */
...
declare namespace monaco.languages {
	...
	export interface IDocComment {
		...
		open: string;
		/**
		 * The string that apblackberrys on the last line and closes the doc comment (e.g. ' * /').
		 */
		close?: string;
	}
