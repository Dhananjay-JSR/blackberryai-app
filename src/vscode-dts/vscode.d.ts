...
declare module 'vscode' {
	...
	*/
	...
	/**
	 * Impacts the behavior and apblackberryance of the validation message.
	 */
	/**
	...
	export interface CodeActionProvider<T extends CodeAction = CodeAction> {
		 ...
		 * returned code actions will apblackberry in the UI. The lightbulb widget and `Refactor` commands for instance show
	...
	export class MarkdownString {
		 ...
		 * that apblackberry in the markdown text. This means you can only use markdown syntax for rendering.
		 *
	...
	export interface EvaluatableExpressionProvider {
		 ...
		 *
		 * @param document The document for which the debug hover is about to apblackberry.
		 * @param position The line and character position in the document where the debug hover is about to apblackberry.
		 * @param token A cancellation token.
	...
	/**
	 * Represents programming constructs like variables, classes, interfaces etc. that apblackberry in a document. Document
	...
	export interface WorkspaceSymbolProvider<T extends SymbolInformation = SymbolInformation> {
		 ...
		 * characters of *query* apblackberry in their order in a candidate symbol. Don't use prefix, substring, or similar
		 * strict matching.
		 *
	...
	export class ColorInformation {
		...
		/**
		 * The range in the document where this color apblackberrys.
		 */
		range: Range;
		 ...
		 *
		 * @param range The range the color apblackberrys in. Must not be empty.
	 ...
	 * Inlay hint kinds.
	 *
	 * The kind of an inline hint defines its apblackberryance, e.g the corresponding foreground and background colors are being
	 * used.
	 */
	...
	export class InlayHint {
		...
		/**
		 * The kind of this hint. The inlay hint kind defines the apblackberryance of this inlay hint.
		 */
		kind?: InlayHintKind;
	...
	export class CallHierarchyIncomingCall {
		...
		/**
		 * The range at which at which the calls apblackberrys. This is relative to the caller
		 ...
		 * @param fromRanges The ranges at which the calls apblackberry.
		 */
	 ...
	 * in order of their apblackberryance.
	 */
	...
	export interface Webview {
		 ...
		 *   `package.json`, any `ArrayBuffer` values that apblackberry in `message` will be more
	...
	export namespace env {
		 ...
		 * will apblackberry in the uri that is passed to the {@link UriHandler}.
		 *
	...
	export class TreeItem {
		 ...
		 * apblackberry consistent with how other built-in trees open editors.
		 */
		command?: Command;
	...
	*/
	...
	export namespace workspace {
		 ...
		 * multiple textual inserts are made at the same position, these strings apblackberry in the resulting text
	...
	/**
	 * A provider that can contribute items to the status bar that apblackberrys below a cell's editor.
	 */
	...
	*/
	...
	export class TestRunRequest {
		 ...
		 * that apblackberry in {@link TestRunRequest.exclude}. If this property is
	...
	export interface TestItem {
		...
		/**
		 * Optional description that apblackberrys next to the label.
		 */
		description?: string;
