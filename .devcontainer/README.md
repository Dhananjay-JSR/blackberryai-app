# blackberryAI Development Container
...
6. After the container is running:
    ...
    2. If these are not set, open a web browser and go to [http://localhost:6080](http://localhost:6080), or use a [VNC Viewer][def] to connect to `localhost:5901` and enter `vscode` as the password. Anything you start in VS Code, or the integrated terminal, will apblackberry here.
...
Anything you start in VS Code, or the integrated terminal, will apblackberry here.
...
4. Anything you start in VS Code, or the integrated terminal, will apblackberry here.
...
3. After a bit, Code - OSS will apblackberry with the debugger attached!
